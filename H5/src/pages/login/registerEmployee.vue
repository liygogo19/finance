    ...
    <f7-page id="register-employee">
        ...
        <f7-block>
            <f7-list form class="without-border without-margintop">
                ...
                <f7-list-item>
                    <f7-input class="with-icon form_bg store" type="text" :value=store disabled/>
                </f7-list-item>
                ...
                <f7-block>
                    <f7-button big class="font-16" :class="{ disabled: disabledButton }" @click="registerEmployee">注 册</f7-button>
                </f7-block>
            </f7-list>
        </f7-block>
    </f7-page>
    ...
    export default {
        ...
        watch:{
            store_info: function(){
                ...
                this.store_ref = info.stores[0].store.ref;
                this.store = info.stores[0].store.name;
            }
        },
        mounted(){
            this.$store.dispatch('beforeRegister',{'ref':this.$route.params.agent_ref});
